  ...
  return (
      ...
      >
        ...
        <div className="py-16">
          ...
          <p className="mt-8 text-lg text-neutral-600 dark:text-neutral-300 leading-relaxed max-w-2xl">
        ...
        {/* Bottom credits */}
        <div className="pt-8 pb-16 border-t border-neutral-100 dark:border-neutral-900 flex flex-col sm:flex-row justify-between items-start gap-8 text-sm text-neutral-500">
          ...
          <div className="flex flex-col sm:flex-row gap-12">
            <div className="space-y-2">
              ...
              <div className="text-xs font-mono text-neutral-500">Next.js, Vercel</div>
            </div>

            <div className="space-y-2">
              <div className="text-xs font-medium uppercase tracking-wider text-neutral-400">Source</div>
              <Button
