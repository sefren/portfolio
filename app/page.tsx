        ...
        <header className="space-y-8">
          <div>
            <div className="flex items-baseline gap-4">
              <h1 className="text-6xl font-extrabold tracking-tight font-space text-[var(--foreground)]">
                Sefren
              </h1>
          ...
          {/* NAV - accent divider + per-link grow underline */}
          <nav className="flex gap-8 text-xs sm:text-sm uppercase tracking-widest text-neutral-500 pb-2 border-b border-[var(--accent)]">
            <a
              href="#work"
              className="relative accent-underline hover:text-neutral-700 dark:hover:text-neutral-300 transition-colors
