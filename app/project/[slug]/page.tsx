...
const statusColors: Record<
    "active" | "completed" | "archived" | "prototype",
    string
> = {
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
              ...
              <div className="flex flex-col items-start lg:items-end gap-2">
                {project.category === "research" && (
                    <span className="text-xs px-3 py-1 rounded-full font-mono uppercase tracking-wider bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800">
                  Research
                </span>
                )}
            ...
            <div className="space-y-6">
              ...
              {project.eli5 && (
                  <div className="border-l-4 border-neutral-300 dark:border-neutral-700 pl-6">
                    <p className="text-base text-neutral-600 dark:text-neutral-400 italic leading-relaxed text-justify">
                      {project.eli5}
                    </p>
                  </div>
              )}
              ...
              <div className="space-y-4">
                <div className="flex flex-wrap gap-3">
                  {project.stack.map((s) => (
                      <span
                          key={s}
                          className="px-2 py-1 text-sm font-mono text-neutral-700 dark:text-neutral-300 bg-neutral-100 dark:bg-neutral-800/50 rounded-md"
                      >
                    {s}
                  </span>
                  ))}
